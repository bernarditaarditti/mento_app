...
export default function HealthLevel1PlayPage() {
  ...
  // Opciones correctas: índice 0 y 1
  // Opción incorrecta: índice 2
        ...
        >
          <div className="flex flex-col gap-3 text-center" style={{ color: "#F36E86", fontFamily: "var(--font-poppins)" }}>
            ...
            <p className="text-sm font-medium">
              Ves una sala de espera hospitalaria con pacientes aguardando. Parece que hay mucha demora.
            </p>
          </div>
        </div>
