...
export default function HealthLevel1Page() {
  ...
  return (
    ...
    >
      ...
      <div className="flex-1 relative px-4 pb-24 pt-2">
        ...
        {/* Popup Card for Level 1 - positioned below level 1 circle */}
        <div
          className="absolute"
          style={{
            top: "18%",
        ...
        >
          ...
          >
            {/* Speech bubble tail pointing up to level 1 circle */}
            {/* Nivel 1 está en left: 15%, top: 5%, el recuadro está centrado, así que el triángulo debe apuntar hacia arriba-izquierda */}
            <div
              className="absolute"
              style={{
                top: "-14px",
            ...
            <div className="flex flex-col items-center gap-1.5" style={{ fontFamily: "var(--font-poppins)" }}>
              ...
              <div className="flex justify-center mt-2" style={{ marginBottom: "-32px" }}>
                <Link href="/islands/health/level-1/game">
                <button
