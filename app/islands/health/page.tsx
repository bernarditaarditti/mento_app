...
export default function HealthIslandPage() {
  ...
  const cargarProgreso = useCallback(async () => {
    ...
    try {
      ...
      if (response.success && response.data) {
        ...
        console.log("✅ Progreso cargado en health page:", { nivelesCompletados, ultimoDesbloqueado });
  ...
  return (
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <div className="px-4 pt-8 pb-2 relative">
        ...
        <h1 className="text-[#52B788] text-xl font-bold text-center mt-16">Salud</h1>
      </div>
