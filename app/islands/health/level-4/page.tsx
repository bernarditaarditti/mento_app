...
export default function HealthLevel4Page() {
  ...
  return (
    ...
    >
      ...
      <div className="flex-1 relative px-4 pb-24 pt-2">
        ...
        {/* Popup Card for Level 4 - positioned above level 4 circle */}
        <div
          className="absolute"
          style={{
            top: "10%",
        ...
        >
          ...
          >
            {/* Speech bubble tail pointing down-right to level 4 circle */}
            <div
              className="absolute"
              style={{
                bottom: "-14px",
            ...
            <div className="flex flex-col items-center gap-1.5" style={{ fontFamily: "var(--font-poppins)" }}>
              ...
              <div className="flex justify-center mt-2" style={{ marginBottom: "-32px" }}>
                <Link href="/islands/health/level-4/game">
                <button
