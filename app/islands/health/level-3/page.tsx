...
export default function HealthLevel3Page() {
  ...
  return (
    ...
    >
      ...
      <div className="flex-1 relative px-4 pb-24 pt-2">
        ...
        {Array.from({ length: totalLevels }, (_, i) => {
          ...
          return (
            ...
            >
              ...
              {level <= currentLevel ? (
                <Link href={`/islands/health/level-${level}`} className="block">
                  <div
                    ...
                    style={{
                      ...
                      boxShadow: "0 4px 12px rgba(0, 180, 111, 0.3)",
                ...
                <div
                  ...
                  style={{
                    backgroundColor: getLevelColor(level),
                    boxShadow: "0 4px 12px rgba(140, 221, 190, 0.3)",
                    fontFamily: "var(--font-poppins)",
                    cursor: "not-allowed",
        ...
        {/* Popup Card for Level 3 - positioned below level 3 circle */}
        <div
          className="absolute"
          style={{
            top: "53%",
        ...
        >
          ...
          >
            {/* Speech bubble tail pointing up to level 3 circle */}
            {/* Nivel 3 está en left: 15%, top: 40%, el recuadro está centrado, así que el triángulo debe apuntar hacia arriba-izquierda */}
            <div
              className="absolute"
              style={{
                top: "-14px",
            ...
            <div className="flex flex-col items-center gap-1.5" style={{ fontFamily: "var(--font-poppins)" }}>
              ...
              <div className="flex justify-center mt-2" style={{ marginBottom: "-32px" }}>
                <Link href="/islands/health/level-3/game">
                <button
