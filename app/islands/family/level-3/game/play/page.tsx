...
export default function FamilyLevel3PlayPage() {
  ...
  // Opción correcta: índice 0 - "Esto nos enseña a organizarnos mejor."
  // Opciones incorrectas: índices 1, 2, 3, 4
  ...
  const handleSubmit = () => {
    ...
    if (correctAnswers.includes(selectedOption)) {
      ...
      localStorage.setItem("family_level_3_completed", "true")
    }
  }
  ...
  return (
    <div className="min-h-screen flex flex-col bg-white">
      ...
      <div className="flex-1 px-4 pb-8 flex flex-col gap-5 max-w-sm mx-auto w-full justify-center pt-0">
        ...
        >
          <div className="flex flex-col gap-3 text-center" style={{ color: "#F36E86", fontFamily: "var(--font-poppins)" }}>
            <p className="text-sm font-medium">
              Mamá/papá está preocupado por un gasto imprevisto en la casa
            </p>
          </div>
        </div>
        ...
        {/* Options - Rectángulos horizontales */}
      ...
      {/* Popup de éxito cuando se selecciona la opción correcta */}
      {showSuccessPopup && (
        <div 
          className="fixed inset-0 bg-black/40 z-50 flex justify-center items-center px-4 cursor-pointer"
