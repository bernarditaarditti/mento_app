...
export default function FamilyLevel3GamePage() {
  const { user } = useAuth()
  ...
  useEffect(() => {
    if (typeof window === "undefined") return
    const completed = localStorage.getItem(`family_level_${levelNumber}_completed`) === "true"
    if (completed) {
      ...
      <div className="flex-1 px-4 pb-3 flex flex-col gap-10 max-w-sm mx-auto w-full overflow-y-auto pt-12" style={{ minHeight: 0 }}>
          ...
          <div className="absolute -top-10 left-1/2 transform -translate-x-1/2" style={{ zIndex: 10 }}>
            <div className="relative">
              ...
              <div
                ...
                style={{ backgroundColor: "#FFC832", fontFamily: "var(--font-poppins)" }}
              >
                3
              </div>
            </div>
        ...
        >
          ...
          <div className="flex justify-center mt-4 flex-shrink-0" style={{ marginBottom: "-32px" }}>
            <Link href="/islands/family/level-3/game/play">
              <button
