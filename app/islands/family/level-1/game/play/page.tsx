...
export default function FamilyLevel1PlayPage() {
  ...
  // Opción correcta: 4 (índice 3) - "Quizás está preocupado por nuestra conexión y esto es su manera de expresarlo"
  // Opciones incorrectas: 1, 2 y 3 (índices 0, 1 y 2)
  const correctAnswers = [3]
  const incorrectAnswers = [0, 1, 2]
  ...
  const getOptionStyle = (index: number) => {
    ...
    if (selectedOption === index && !evaluated) {
      return { backgroundColor: "#F9B702" } // Color cuando está seleccionada
    }
