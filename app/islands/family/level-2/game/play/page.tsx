...
export default function FamilyLevel2PlayPage() {
  ...
  // Opciones correctas: "Pasar tiempo en casa jugando juegos de mesa." (índice 2), "Aprovechar para cocinar juntos una comida especial." (índice 3), "Hacer una tarde de películas en familia." (índice 5)
  // Opciones incorrectas: "Mejor cada uno hace lo suyo, ya está todo perdido." (índice 0), "Todo arruinado, el día ya no sirve." (índice 1), "No hay nada que pueda reemplazar este plan." (índice 4)
  ...
  const getOptionStyle = (index: number) => {
    ...
    // Si está seleccionada pero aún no evaluada, mostrar color amarillo oscuro
    if (selectedOptions.includes(index) && !evaluated) {
      return { backgroundColor: "#FFC832" } // Amarillo cuando está seleccionada
    }
    
    // Estado inicial: amarillo claro
    return { backgroundColor: "#FFDF87" }
  }
        ...
        <div className="grid grid-cols-2 gap-3 relative max-w-[280px] mx-auto">
          {options.map((option, index) => (
            <button
              ...
              onMouseEnter={(e) => {
                if (!evaluated && !selectedOptions.includes(index)) {
                  e.currentTarget.style.backgroundColor = "#FFC832"
                }
              ...
              onMouseLeave={(e) => {
                if (!evaluated && !selectedOptions.includes(index)) {
                  e.currentTarget.style.backgroundColor = "#FFDF87"
                }
                setHoveredOption(null)
              }}
            >
            ...
            >
              ...
              <div className="flex flex-col gap-3" style={{ fontFamily: "var(--font-poppins)" }}>
                ...
                <p
                  ...
                  style={{ fontSize: "16px" }}
                >
                  Reinterpretar la situación de manera constructiva te ayuda a encontrar alternativas positivas
                </p>
              </div>
            </div>
          </div>
