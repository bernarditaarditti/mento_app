  ...
  const cargarProgreso = useCallback(async () => {
    ...
    try {
      ...
      if (response.success && response.data) {
        ...
        console.log("✅ Progreso cargado en family page:", { nivelesCompletados, ultimoDesbloqueado });
            ...
            >
              ...
              {isLevelUnlocked(level) ? (
                <Link href={`/islands/family/level-${level}`} className="block">
                  <div
                    ...
                    style={{
                      ...
                      boxShadow: "0 4px 12px rgba(255, 200, 50, 0.3)",
                ...
                <div
                  ...
                  style={{
                    backgroundColor: getLevelColor(level),
                    boxShadow: "0 4px 12px rgba(255, 223, 135, 0.3)",
                    fontFamily: "var(--font-poppins)",
                    cursor: "not-allowed",
