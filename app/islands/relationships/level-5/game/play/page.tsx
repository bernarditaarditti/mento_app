...
export default function RelationshipsLevel5PlayPage() {
  ...
  // Opciones correctas (validan + reencuadran constructivamente): índices 0, 4, 5
  // Opciones incorrectas (evitación, minimización, catastrofismo): índices 1, 2, 3
  const correctAnswers = [0, 4, 5]
  ...
  const handleSubmit = () => {
    ...
    if (allSelectedAreCorrect) {
      ...
      localStorage.setItem("relationships_level_5_completed", "true")
    } else {
  ...
  // Pantalla del juego
  const options = [
    "Entiendo que duela, es horrible sentirse solo. Buscar apoyo ya muestra tu fortaleza.",
    ...
    "Acá estoy. A veces sentirse incomprendido no significa que estés solo; podemos pensar juntos qué necesitás.",
  ...
  return (
    <div className="min-h-screen flex flex-col bg-white">
      ...
      <div className="flex-1 px-4 pb-8 flex flex-col gap-5 max-w-sm mx-auto w-full justify-center pt-0">
        ...
        >
          <div className="flex flex-col gap-3 text-center" style={{ color: "#F36E86", fontFamily: "var(--font-poppins)" }}>
            <p className="text-sm font-medium">
              Un amigo te escribe:
              <br />
              <span className="font-bold">"Me siento re mal, nadie me entiende"</span>
            </p>
          </div>
        </div>
        ...
        >
          Seleccioná todas las respuestas que validen y reencuadren constructivamente
        </h2>
            ...
            <div 
              ...
              onClick={() => {
                if (typeof window !== "undefined") {
                  sessionStorage.setItem("reappraisal_interpersonal_return_path", pathname)
                }
                router.push("/reappraisal-interpersonal")
              }}
            >
