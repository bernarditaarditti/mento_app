...
export default function RelationshipsLevel2GamePage() {
  const { user } = useAuth()
  ...
  return (
    <div className="min-h-screen flex flex-col bg-white" style={{ height: "100vh", maxHeight: "100vh", overflow: "hidden" }}>
      ...
      <div className="flex-1 px-4 pb-3 flex flex-col gap-10 max-w-sm mx-auto w-full overflow-y-auto pt-12" style={{ minHeight: 0 }}>
        {/* Pink Box - Top */}
        <div
          className="rounded-xl px-4 py-8 flex-shrink-0 relative mt-8 mx-auto"
          style={{ backgroundColor: "rgba(255, 199, 209, 0.82)", maxWidth: "80%" }}
        >
        ...
        {/* Blue Box - Bottom */}
        <div
          className="rounded-xl p-4 flex flex-col mx-auto relative pb-0"
          style={{ backgroundColor: "#C7EAF5", maxWidth: "80%", paddingTop: "2.5rem", marginTop: "40px" }}
        >
          ...
          <div className="flex justify-center mt-4 flex-shrink-0" style={{ marginBottom: "-32px" }}>
            <Link href="/islands/relationships/level-2/game/play">
              <button
