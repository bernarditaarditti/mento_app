...
export default function RelationshipsLevel2PlayPage() {
  ...
  // Opciones correctas (repurposing): índices 0, 2, 4
  // Opciones incorrectas: índices 1, 3, 5
  const correctAnswers = [0, 2, 4]
  const incorrectAnswers = [1, 3, 5]
  ...
  const handleSubmit = () => {
    ...
    if (allSelectedAreCorrect) {
      ...
      localStorage.setItem("relationships_level_2_completed", "true")
    } else {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-white">
      ...
      <div className="flex-1 px-4 pb-8 flex flex-col gap-5 max-w-sm mx-auto w-full justify-center pt-0">
        ...
        >
          <div className="flex flex-col gap-3 text-center" style={{ color: "#F36E86", fontFamily: "var(--font-poppins)" }}>
            <p className="text-sm font-medium">
              ...
              <br />
              <span className="font-bold">Sentís decepción y pensás que el día está arruinado</span>
            </p>
          </div>
        </div>
        ...
        >
          Seleccioná todas las reinterpretaciones que correspondan
        </h2>
