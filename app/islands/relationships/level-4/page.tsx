...
export default function RelationshipsLevel4Page() {
    ...
    >
      ...
      <div className="flex-1 relative px-4 pb-24 pt-2">
        ...
        >
          ...
          >
            {/* Speech bubble tail pointing down to level 4 circle */}
            <div
              className="absolute"
              style={{
                bottom: "-14px",
            ...
            <div className="flex flex-col items-center gap-1.5" style={{ fontFamily: "var(--font-poppins)" }}>
              ...
              {getStarColor(4) && (
                <svg
                  ...
                  fill={getStarColor(4)}
                >
                  <path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z" stroke={getStarColor(4)} strokeWidth="1.5" strokeLinejoin="round" />
                </svg>
              )}
              ...
              <div className="flex justify-center mt-2" style={{ marginBottom: "-32px" }}>
                <Link href="/islands/relationships/level-4/game">
                  <button
