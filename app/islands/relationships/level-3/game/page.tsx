...
export default function RelationshipsLevel3GamePage() {
  const { user } = useAuth()
  ...
  return (
    <div className="min-h-screen flex flex-col bg-white" style={{ height: "100vh", maxHeight: "100vh", overflow: "hidden" }}>
      ...
      <div className="flex-1 px-4 pb-3 flex flex-col gap-10 max-w-sm mx-auto w-full overflow-y-auto pt-12" style={{ minHeight: 0 }}>
        {/* Pink Box - Top */}
        <div
          className="rounded-xl flex-shrink-0 relative mt-4 mx-auto"
          style={{ backgroundColor: "rgba(255, 199, 209, 0.82)", maxWidth: "75%", padding: "0.75rem 1rem 1rem 1rem" }}
        >
          ...
          <div className="flex flex-col gap-2 mt-4" style={{ color: "#FF8FA3", fontFamily: "var(--font-poppins)" }}>
            ...
            <div className="text-center mt-2">
              ...
              >
                Practica dar apoyo constructivo que ayude a reinterpretar situaciones difíciles.
              </p>
            </div>
          </div>
        </div>
        ...
        >
          ...
          <div className="flex flex-col gap-2 mt-2" style={{ color: "#0096C7", fontFamily: "var(--font-poppins)" }}>
            ...
            <div className="flex flex-col gap-1.5 font-normal text-center" style={{ fontSize: "16px", lineHeight: "1.5" }}>
              <p>
                Se te presentará una situación difícil que está travesando un familiar o amigo tuyo.
              </p>
              <p className="mt-2">
          ...
          <div className="flex justify-center mt-4 flex-shrink-0" style={{ marginBottom: "-32px" }}>
            <Link href="/islands/relationships/level-3/game/play">
              <button
