...
export default function WorkLevel5Page() {
  ...
  useEffect(() => {
    ...
    const level1Completed = localStorage.getItem("work_level_1_completed")
    const level2Completed = localStorage.getItem("work_level_2_completed")
    const level3Completed = localStorage.getItem("work_level_3_completed")
    const level4Completed = localStorage.getItem("work_level_4_completed")
      ...
      <div className="flex-1 relative px-4 pb-24 pt-2">
        ...
        >
          ...
          >
            ...
            {/* Nivel 5 está en left: 15%, top: 72%, el recuadro está centrado, así que el triángulo debe apuntar hacia abajo-izquierda */}
            <div
              className="absolute"
              style={{
                bottom: "-14px",
            ...
            <div className="flex flex-col items-center gap-1.5" style={{ color: "#FF8FA3", fontFamily: "var(--font-poppins)" }}>
              ...
              <div className="flex justify-center mt-2" style={{ marginBottom: "-32px" }}>
                <Link href="/islands/work/level-5/game">
                <button
