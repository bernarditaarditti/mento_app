...
export default function WorkLevel3PlayPage() {
  ...
  // Opciones correctas: "Quizás esta no era la beca adecuada, podés aplicar a otra con más chances" (índice 1)
  // Opciones incorrectas: "Sí, es injusto, quizás no vale la pena seguir intentando" (índice 0), "Tranquilo, olvidate del tema y no pienses más" (índice 2)
  const correctAnswers = [1]
  const incorrectAnswers = [0, 2]
  ...
  const handleSubmit = () => {
    ...
    if (correctAnswers.includes(selectedOption)) {
      ...
      // Marcar el nivel 3 como completado en localStorage
      localStorage.setItem("work_level_3_completed", "true")
    }
  }
  ...
  const options = [
    ...
    "Tranquilo, olvidate del tema y no pienses más"
  ]
  ...
  return (
    <div className="min-h-screen flex flex-col bg-white">
      ...
      {/* Main Content */}
      <div className="flex-1 px-4 pb-8 flex flex-col max-w-sm mx-auto w-full pt-0">
        {/* Scenario Box - Pink */}
        <div
          className="rounded-2xl p-5 mx-auto"
          style={{ backgroundColor: "#FFC7D1", maxWidth: "85%", marginTop: "120px" }}
        >
          <div className="flex flex-col gap-3" style={{ color: "#F36E86", fontFamily: "var(--font-poppins)" }}>
            <p className="font-medium text-center" style={{ fontSize: "15px" }}>
              Un colega no fue elegido para una beca, por lo que piensa que nunca voy a progresar y que no sirve para nada
            </p>
          </div>
        </div>
        ...
        >
          ¿Cómo responderías para ayudarlo a reinterpretar la situación?
        </h2>

        {/* Options */}
        <div className="flex flex-col gap-3 relative mx-auto" style={{ maxWidth: "85%", marginTop: "32px" }}>
          {options.map((option, index) => (
            <button
              ...
              className="rounded-xl p-3.5 text-white text-center font-normal transition-colors flex items-center justify-center"
              style={{
            ...
            >
              ...
              <div className="flex flex-col gap-3" style={{ fontFamily: "var(--font-poppins)" }}>
                ...
                <p
                  ...
                  style={{ fontSize: "16px" }}
                >
                  Evadir no es una buena forma de manejar lo que a uno le pasa, es preferible trabajarlo para estar mejor preparado
                </p>
              </div>
            </div>
          </div>
            ...
            >
              ...
              <div className="flex flex-col gap-3" style={{ fontFamily: "var(--font-poppins)" }}>
                ...
                <p
                  ...
                  style={{ fontSize: "16px" }}
                >
                  Esta respuesta ayuda a reinterpretar la situación como una mala coincidencia específica en lugar de una falla personal
                </p>
              </div>
            </div>
          </div>
