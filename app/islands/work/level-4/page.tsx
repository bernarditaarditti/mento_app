...
export default function WorkLevel4Page() {
      ...
      <div className="flex-1 relative px-4 pb-24 pt-2">
        ...
        >
          ...
          >
            ...
            {/* Nivel 4 está en right: 15%, top: 53%, el recuadro está centrado arriba, así que el triángulo debe apuntar hacia abajo-derecha */}
            <div
              className="absolute"
              style={{
                bottom: "-14px",
            ...
            <div className="flex flex-col items-center gap-1.5" style={{ fontFamily: "var(--font-poppins)" }}>
              ...
              <div className="flex justify-center mt-2" style={{ marginBottom: "-32px" }}>
                <Link href="/islands/work/level-4/game">
                  <button
