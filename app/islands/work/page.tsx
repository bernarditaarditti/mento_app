  ...
  const cargarProgreso = useCallback(async () => {
    ...
    try {
      ...
      if (response.success && response.data) {
        ...
        console.log("✅ Progreso cargado en work page:", { nivelesCompletados, ultimoDesbloqueado, responseData: response.data });
      ...
      <div className="flex-1 relative px-4 pb-24 pt-2">
        ...
        {Array.from({ length: totalLevels }, (_, i) => {
          ...
          return (
            ...
            >
              {/* Star above levels */}
              {/* Mostrar estrella solo para niveles completados o el siguiente a jugar */}
              {starColor && (
              ...
              {isLevelUnlocked(level) ? (
                <Link href={`/islands/work/level-${level}`} className="block">
                  <div
