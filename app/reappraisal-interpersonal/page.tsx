...
export default function ReappraisalInterpersonalPage() {
  ...
  useEffect(() => {
    ...
    const savedPath = sessionStorage.getItem("reappraisal_interpersonal_return_path")
    if (savedPath) {
    ...
    if (typeof window !== "undefined" && document.referrer) {
      try {
        ...
        if (referrerPath.includes("/game/play/")) {
          ...
          sessionStorage.setItem("reappraisal_interpersonal_return_path", referrerPath)
        }
      } catch (e) {
        ...
        <div className="relative w-full max-w-[290px] flex flex-col items-center rounded-2xl p-6" style={{ backgroundColor: "#FFC7D1", opacity: 0.82 }}>
          <div className="flex flex-col items-center justify-start" style={{ fontFamily: "var(--font-poppins)" }}>
            ...
            <p className="text-center leading-relaxed px-4" style={{ color: "#F36E86", fontSize: "17px" }}>
              Este nivel usa <strong style={{ color: "#F36E86" }}>"Reappraisal interpersonal"</strong>,
              <br />
              <br />
              una estrategia que consiste en <strong style={{ color: "#F36E86" }}>reinterpretar</strong> lo que otra persona dijo o hizo.
              <br />
              <br />
              No se trata de justificar comportamientos dañinos, sino de abrir espacio a <strong style={{ color: "#F36E86" }}>interpretaciones más realistas</strong> y <strong style={{ color: "#F36E86" }}>reducir conclusiones automáticas</strong>.
            </p>
          </div>
        </div>
      </div>
